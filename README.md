...
MVP-скелет: API и база данных готовы, LLM-интеграция пока заглушка.
...
app/
  ...
  fake_llm.py   # заглушка LLM (заменить на реальный вызов)
supabase_schema.sql
requirements.txt
.env.example
```
...
- [ ] Подключить реальный LLM через 


- [ ] Аутентификация пользователей
- [ ] Обработка ошибок (404, невалидный ответ от LLM)
- [ ] Тесты
